...
| `542-la-campagne-de-presence-reste-dans-competitions` | **Tranchée le 2026-09-11 : statu quo.** Une frontière passerait au milieu d'`etat_du_panneau`, que R24 oblige à lire la campagne *et* la journée ; le journal d'envois imposerait une écriture chez le voisin ou une copie de `claim`/`confirm` ; et le couplage s'est épaissi de cinq cartes à l'autre. Ce que la décision garde est vérifié par l'axe 18 : hors câblage, rien n'appelle le périmètre |
