...
| [E13 — Gestion des erreurs coûteuses](ready_to_be_done/E13-gestion-des-erreurs-couteuses.md) | `ready` · 0/4 | 4 |
...
| `414-archiver-une-saison` | On n'implémentera pas de suppression : dix tables portent `season_id` et les trois flux d'événements n'en portent aucun. Une saison finie se range, elle ne se détruit pas — et l'archivage doit aussi taire le cron d'e-mails |
