...
| `396-reprendre-un-rapport-de-match-en-cours` | Rouvrir un rapport entamé ramène toujours au facteur fans, qu'on peut réenregistrer — recette et TV avec. `PreMatch` est un seul état pour quatre étapes |
