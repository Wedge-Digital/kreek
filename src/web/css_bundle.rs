...
const FEUILLES_APP: &[&str] = &[
    ...
    "pages/competition-admin-presences.css",
    "pages/competition-admin-schedule.css",
    "pages/competition-admin-settings.css",
    ...
    "pages/presence-call.css",
    "pages/ranking-manual-points.css",
    "pages/space-admin.css",
    "pages/team-build.css",
    "pages/team-page.css",
    "pages/team-treasury.css",
