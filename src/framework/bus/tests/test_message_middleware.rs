use std::any::Any;
use crate::framework::bus::tests::generic_middleware::GenericMessageMiddleware;
...
pub fn assert_instanciate_message_middleware() {
    let mut middleware_1 = GenericMessageMiddleware::new();
    let middleware_2 = GenericMessageMiddleware::new();
...
pub fn assert_chain_handle_message_middleware() {
    let mut middleware_1 = GenericMessageMiddleware::new();
    let mut middleware_2 = GenericMessageMiddleware::new();
