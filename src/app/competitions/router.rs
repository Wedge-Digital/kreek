...
use crate::app::competitions::io::web::new_competition::{get_members_widget, get_new_competition_phase_1, get_new_competition_phase_2, post_new_competition};
...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route(path::COMPETITION_NEW_RULES,   get(get_new_competition_phase_2))
}