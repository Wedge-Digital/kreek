...
use crate::app::competitions::io::web::competition_detail::{get_competition_detail, get_tab_standings, get_tab_matches, get_tab_teams, get_tab_stats};
...
use crate::app::competitions::io::web::competition_widget::{get_competition_widget, get_competition_widget_seasons, get_competition_widget_detail};
...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route(path::COMPETITION_WIDGET_SEASONS,  get(get_competition_widget_seasons))
