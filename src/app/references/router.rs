...
use crate::app::references::io::web::inducement_selector_controller::inducement_selector_controller;
...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route(path::INDUCEMENT_SELECTOR, get(inducement_selector_controller))
