...
impl fmt::Display for AuthDomainError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            AuthDomainError::CoachNameTooLong       => write!(f, "Le nom du coach ne peut pas dépasser 50 caractères"),
            AuthDomainError::CoachNameInvalidChars  => write!(f, "Le nom du coach ne peut contenir que des lettres, chiffres et espaces"),
