...
pub enum SpacesAppEvent {
    SpaceCreated        { event_id: EventId, space_id: SpaceId, space_name: SpaceName, space_logo: CloudinaryImage, created_by: CoachId },
    UserSubscribed      { event_id: EventId, user_id: CoachId, space_id: SpaceId, space_profile: SpaceProfile},
    UserUnsubscribed    { event_id: EventId, user_id: CoachId, space_id: SpaceId},
}
