#[cfg(test)]
mod tests {
    use crate::app::team_creation::common_types::BaseTeamInfo;
    use crate::app::team_creation::error::DomainError;
    use crate::app::team_creation::roster::{
        CrossLimit, PlayerId, PlayerDefinition, PlayerMaxQuantity, PlayerName, PlayerPrice,
        RerollBasePrice, Roster, RosterId, RosterName,
    };
    use crate::app::team_creation::ruleset::{
        CreationBudget, Ruleset, RulesetId, RulesetName, RosterTier, TierId, TierName,
    };
    use crate::app::team_creation::team_draft::DraftTeam;
    use crate::app::team_creation::team_roster_selected::{MAX_REROLL_COUNT, RosterSelectedTeam};
    use crate::app::team_creation::team_ruleset_selected::RulesetSelectedTeam;
    use crate::app::team_creation::team_staff::{
        StaffId, StaffKind, StaffMaxQuantity, StaffName, StaffPrice, TeamStaff,
    };
    use crate::services::id_service::{FakeIdService, IdService};
    ...
    fn make_roster_selected(roster: Roster, ruleset: Ruleset) -> RosterSelectedTeam {
        ...
        let base = BaseTeamInfo::new("Les Bleus".to_string(), creator_id.clone(), None);
